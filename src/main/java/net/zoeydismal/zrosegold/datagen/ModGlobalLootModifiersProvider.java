...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        add("rose_gold_apple_from_mineshafts", new AddItemModifier(new LootItemCondition[]{
                ...
                LootItemRandomChanceCondition.randomChance(0.55f).build()}, ModItems.ROSEGOLD_APPLE.get()));

        add("rose_gold_apple_from_desert_pyramid", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("chests/desert_pyramid")).build(),
                LootItemRandomChanceCondition.randomChance(0.45f).build()}, ModItems.ROSEGOLD_APPLE.get()));

        add("rose_gold_apple_from_simple_dungeon", new AddItemModifier(new LootItemCondition[]{
                new LootTableIdCondition.Builder(new ResourceLocation("chests/simple_dungeon")).build(),
                LootItemRandomChanceCondition.randomChance(0.5f).build()}, ModItems.ROSEGOLD_APPLE.get()));
        ...
        add("rose_gold_apple_from_underwater_ruin_big", new AddItemModifier(new LootItemCondition[]{
                ...
                LootItemRandomChanceCondition.randomChance(0.2f).build()}, ModItems.ROSEGOLD_APPLE.get()));
    }
}
